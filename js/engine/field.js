...
const MAPS = {
  home: {
    ...
    bgm: "bgm_field",
    w: 5, h: 5,
    exits: [{ x: 4, y: 0, to: "field", tx: 4, ty: 0, label: "フィールド" }],
    encounter: null,
  },
  field: {
    name: "田辺の町・郊外",
    ...
    w: 9, h: 9,
    exits: [
      { x: 4, y: 0, to: "home", tx: 4, ty: 0, label: "自宅" },
      { x: 2, y: 7, to: "town", tx: 4, ty: 5, label: "町" },
  ...
  town: {
    ...
    bgm: "bgm_town",
    w: 7, h: 7,
    exits: [{ x: 4, y: 6, to: "field", tx: 2, ty: 6, label: "郊外" }],
    buildings: [
      { x: 4, y: 1, id: "jobcenter", name: "職安" },
      { x: 1, y: 2, id: "weaponshop", name: "武器屋" },
      { x: 6, y: 2, id: "itemshop", name: "道具屋" },
      { x: 1, y: 4, id: "tavern", name: "酒場" },
      { x: 6, y: 4, id: "inn", name: "宿屋" },
    ],
    encounter: null,
  },
  practice: {
    ...
    bgm: "bgm_field",
    w: 5, h: 5,
    exits: [{ x: 0, y: 3, to: "field", tx: 7, ty: 1, label: "戻る" }],
    encounter: null,
  ...
  dungeon: {
    ...
    bgm: "bgm_dungeon",
    w: 9, h: 9,
    exits: [{ x: 5, y: 8, to: "field", tx: 7, ty: 5, label: "出口" }],
    encounter: { table: "dungeon", rate: 0.18 },
    boss: { x: 5, y: 6, id: "seitaishi", label: "整体師" },
    hiddenNpc: { x: 5, y: 1, id: "oldman_mat", label: "老人" },
  },
};
