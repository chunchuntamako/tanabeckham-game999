...
const MAPS = {
  home: {
    ...
    bgm: "bgm_field",
    w: 5, h: 5,
    exits: [{ x: 2, y: 0, to: "field", tx: 2, ty: 0, label: "フィールド" }],
    encounter: null,
  },
  field: {
    name: "田辺の町・郊外",
    ...
    w: 9, h: 9,
    exits: [
      { x: 2, y: 0, to: "home", tx: 2, ty: 0, label: "自宅" },
      { x: 7, y: 0, to: "practice", tx: 0, ty: 3, label: "練習場" },
      { x: 4, y: 8, to: "town", tx: 4, ty: 8, label: "町" },
      { x: 7, y: 6, to: "dungeon", tx: 4, ty: 8, label: "洞窟" },
    ],
  ...
  town: {
    ...
    bgm: "bgm_town",
    w: 9, h: 9,
    exits: [{ x: 4, y: 8, to: "field", tx: 4, ty: 8, label: "郊外" }],
    buildings: [
      { x: 4, y: 2, id: "jobcenter", name: "職安" },
      { x: 2, y: 4, id: "weaponshop", name: "武器屋" },
      { x: 6, y: 4, id: "itemshop", name: "道具屋" },
      { x: 2, y: 6, id: "tavern", name: "酒場" },
      { x: 6, y: 6, id: "inn", name: "宿屋" },
    ],
    encounter: null,
  },
  practice: {
    ...
    bgm: "bgm_field",
    w: 5, h: 5,
    exits: [{ x: 0, y: 3, to: "field", tx: 7, ty: 0, label: "戻る" }],
    encounter: null,
  ...
  dungeon: {
    ...
    bgm: "bgm_dungeon",
    w: 9, h: 9,
    exits: [{ x: 4, y: 8, to: "field", tx: 7, ty: 6, label: "出口" }],
